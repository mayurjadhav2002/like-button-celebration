...
function ThumbLike(props) {
  const [thumblike, setThumblike] = useState(props.Active & true);
  party.resolvableShapes["customShape"] = props.Image ? `<img src=${props.Image} width='24' height='24' /> ` : ['circle', 'square'];

  const partyFun = (e) => {
    setThumblike(!thumblike);
    party.confetti(e, {
      ...
      >
        ...
        {thumblike ?
          ...
          width={props.IconWidth ? props.IconWidth : '24'} height={props.IconHeight?props.IconHeight : '24'}
            ...
            className="bi bi_hand_thumbs_up_fill" viewBox="0 0 16 16">
